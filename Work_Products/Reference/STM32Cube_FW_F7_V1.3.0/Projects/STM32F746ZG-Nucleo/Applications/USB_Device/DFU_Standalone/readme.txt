...
use USB device application based on the Device Firmware Upgrade (DFU) on the STM32F746ZG devices.

This is a typical application on how to use the STM32F746 USB OTG Device peripheral to implement the DFU
capability for programming the embedded flash memory of the STM32F746ZG devices.
